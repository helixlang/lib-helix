...
u128::u128() : high(0), low(0) {}
u128::u128(u64 val) : high(0), low(val) {}
u128::u128(u32 val) : high(0), low(static_cast<u64>(val)) {}
u128::u128(u16 val) : high(0), low(static_cast<u64>(val)) {}
u128::u128(u8 val) : high(0), low(static_cast<u64>(val)) {}
u128::u128(i64 val) : high(0), low(static_cast<u64>(val)) {}
u128::u128(i32 val) : high(0), low(static_cast<u64>(static_cast<u32>(val))) {}
u128::u128(i16 val) : high(0), low(static_cast<u64>(static_cast<u16>(val))) {}
u128::u128(i8 val) : high(0), low(static_cast<u64>(static_cast<u8>(val))) {}
u128::u128(u64 high, u64 low) : high(high), low(low) {}
u128::u128(const i128& x) : high(x.high), low(x.low) {}
...
u128 u128::operator/(const u128& divisor) const {
    if (divisor.high == 0 && divisor.low == 0) return u128(0);
    u128 quotient = 0;
    u128 remainder = 0;
    for (int i = 127; i >= 0; --i) {
...
u128 u128::operator++(int) { u128 temp = *this; ++*this; return temp; }
u128& u128::operator--() { return *this -= u128(1); }
u128 u128::operator--(int) { u128 temp = *this; --*this; return temp; }
